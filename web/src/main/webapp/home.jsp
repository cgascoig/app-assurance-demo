            ...
            <table>
                ...
                <tr>
                    <td class="home">
                        ...
                        <br />&nbsp;Regular: <s:property value="fuelPrices.regular" />
                        <br />&nbsp;Mid Grade: <s:property value="fuelPrices.midgrade" />
                        <br />&nbsp;Premium: <s:property value="fuelPrices.premium" />
                        <br />&nbsp;E85: <s:property value="fuelPrices.e85" />
                        <br />&nbsp;Diesel: <s:property value="fuelPrices.diesel" />
                        <br/><br/><br/>
                    </td>
                </tr>
            </table>
